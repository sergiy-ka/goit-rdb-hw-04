...
![p1_query](./assets/p1_query.png)
![p1_ER_diagram](./assets/p1_ER_diagram.png)

## 2. Заповніть таблиці простими видуманими тестовими даними.

[Query](./assets/p2_query.sql)
![p2_query](./assets/p2_query.png)
![p2_data](./assets/p2_data.png)
...
![p4_1_query+data](./assets/p4_1_query+data.png)
![p4_2_query+data](./assets/p4_2_query+data.png)
![p4_3_query+data](./assets/p4_3_query+data.png)
![p4_4_query+data](./assets/p4_4_query+data.png)
![p4_5_query+data](./assets/p4_5_query+data.png)
![p4_6_query+data](./assets/p4_6_query+data.png)
![p4_7_query+data](./assets/p4_7_query+data.png)
